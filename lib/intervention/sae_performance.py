...
def eval(args, use_sae):
    ...
    if use_sae:
        ...
        print("SAE is not used in the experiments")
...
if __name__ == "__main__":
    ...
    outpath = "./results/sae_performance"
    ...
    for use_sae in [False, True]:
        ...
        result = eval(args, use_sae=use_sae)
        with open(
            os.path.join(
                outpath,
                f"{args.label}_{args.checkpoint_mode}_use_sae={use_sae}",
            ),
            "w",
        ) as f:
