...
class TestConsecutiveIntHuggingFaceDataset:
    ...
    def create_dataset(self) -> ConsecutiveIntHuggingFaceDataset:
        ...
        """
        return ConsecutiveIntHuggingFaceDataset(
            context_size=10, vocab_size=1000, n_items=100
        )
    ...
    def test_dataset_len(
        self, create_dataset: ConsecutiveIntHuggingFaceDataset
    ) -> None:
        ...
        expected_length = 100
        assert (
            len(create_dataset) == expected_length
        ), "Dataset length is not as expected."
