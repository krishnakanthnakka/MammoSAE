...
def setup_activation_resampler(
    ...
    return ActivationResampler(
        ...
        * hyperparameters["source_model"]["hook_dimension"],
        ...
        resample_dataset_size=hyperparameters["activation_resampler"][
...
def setup_source_data(hyperparameters: RuntimeHyperparameters) -> SourceDataset:
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        hyperparameters["source_data"]["tokenizer_name"]
    )
...
def run_training_pipeline(
    ...
    pipeline.run_pipeline(
        ...
        validation_n_activations=hyperparameters["pipeline"][
