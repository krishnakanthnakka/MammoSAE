...
class LearnedActivationsL1Loss(AbstractLoss):
    ...
    def __init__(
        self,
        l1_coefficient: (
            PositiveFloat | Float[Tensor, Axis.names(Axis.COMPONENT_OPTIONAL)]
        ),
    ) -> None:
    ...
    def scalar_loss_with_log(
        ...
        metrics: list[MetricResult] = [
            ...
            MetricResult(
                ...
                component_wise_values=(
                    batch_scalar_loss_penalty.unsqueeze(0)
        ...
        return LossResultWithMetrics(
            loss=batch_scalar_loss_penalty, loss_metrics=metrics
        )
