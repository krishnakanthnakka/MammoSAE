...
def test_hook_replaces_activations() -> None:
    ...
    autoencoder = SparseAutoencoder(
        source_model.cfg.d_model, source_model.cfg.d_model * 2
    )

    tokens: Int[Tensor, Axis.names(Axis.SOURCE_DATA_BATCH, Axis.POSITION)] = (
        source_model.to_tokens("Hello world")
    )
