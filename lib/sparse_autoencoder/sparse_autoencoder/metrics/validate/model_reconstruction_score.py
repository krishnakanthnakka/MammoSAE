...
class ModelReconstructionScore(AbstractValidationMetric):
    ...
    def calculate(self, data: ValidationMetricData) -> list[MetricResult]:
        ...
        zero_ablate_loss_minus_reconstruction_loss: Float[
            ...
            data.source_model_loss_with_zero_ablation
            - data.source_model_loss_with_reconstruction
        )
        ...
        validation_loss_with_reconstruction = (
            data.source_model_loss_with_reconstruction.mean(0)
        )
        validation_loss_with_zero_ablation = (
            data.source_model_loss_with_zero_ablation.mean(0)
        )
